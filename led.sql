...
--
-- Host: localhost    Database: test_copy
-- ------------------------------------------------------
...
CREATE TABLE `led` (
  `stt` int(11) NOT NULL,
  `red` mediumint(9) NOT NULL,
  `green` mediumint(9) NOT NULL,
...
INSERT INTO `led` VALUES (1,10,2,3);
...
-- Dump completed on 2021-05-10 14:01:35
